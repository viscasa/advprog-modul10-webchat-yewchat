...
impl Component for Chat {
    ...
    fn create(ctx: &Context<Self>) -> Self {
        ...
        if username == "initial" || username.is_empty() {
            log::warn!("Skip WebSocket connection: username belum valid: {:?}", username);
            return Self {
                users: vec![],
                messages: vec![],
                chat_input: NodeRef::default(),
                wss: WebsocketService::dummy(),  // implement dummy tx atau Option<WebsocketService>
